...
{
$sql=mysqli_query($con,"SELECT password FROM  staff_user where Password='".md5($_POST['password'])."' && Employee_Id='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update staff_user set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where Employee_Id='".$_SESSION['alogin']."'");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Management Change Password</h3>
							</div>
