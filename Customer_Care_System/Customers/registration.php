...
<html lang="en">
  <head>
    ...
    <title>Customer Care System | New Customer User Registration</title>
...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#fff"><a href="../web/index.html" style="color:#fff">Customer Care System</a></h3>
	<hr />
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">New Customer User Registration</h2>
...
echo htmlentities($msg);
    ...
    <script>
        $.backstretch("assets/img/reg.jpg", {speed: 500});
    </script>
<div class="footer">
		<div class="container">
