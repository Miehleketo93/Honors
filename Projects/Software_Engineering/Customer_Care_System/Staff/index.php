...
{
$ret=mysqli_query($con,"SELECT * FROM staff WHERE email='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
$query=mysqli_query($con,"SELECT * FROM staff WHERE email='$email' and phone='$phone'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update staff set password='$password' WHERE email='$email' and phone='$phone' ");
$msg="Password Changed Successfully";

}
else
{
$errormsg="Invalid email id or phone no";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>Customer Care System | Staff Login</title>
...
<input type="text" name="phone" placeholder="phone No" autocomplete="off" class="form-control" required><br>
