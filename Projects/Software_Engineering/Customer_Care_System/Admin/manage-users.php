...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/Customer_Care_System/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
